...
const HTML = `<!-- Start of body -->
    
    
<!-- Intro audio -->
<audio autoplay style="position:absolute;">
    <source src="/Hypermedia/Infornography/CoplandOSIntro.mp3" type="audio/mpeg"/></audio>
<!-- end of Intro audio -->

<marquee class="clines" scrollamount="20" direction="right" style="top:0px;left:0px;">CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS</marquee>  

<!-- Start of label -->
<div style="position:fixed;color:red;font-family:monospace;top:-10px;left:-10px;z-index:-1;">
<img draggable="false" alt="OS" src="/img/coplandlabel.png"/></div>
<!-- End of label -->

<!-- Start of Safe Mode -->
<div style="position:fixed;color:red;font-family:monospace;top:50%;left:50%;margin-top: -80px;margin-left: -184px;text-align:center;z-index:-99;">
  <p style="font-size:2em;" class="safe">CORRUPTION DETECTED</p>
  <p style="font-size:3em;" class="safe">SAFE MODE ENABLED</p>
  <p style="font-size:2em;" class="safe">ACCESS LIMITED</p>
</div><!-- End of Safe Mode -->

<!-- CRowViewCL Application START -->
<div id="cv">
    
<p id="cv_close">X</p>
<!-- TITLE START-->
<div class="handle">
    <img alt="AppIcon" src="/img/ShrunkenCoplandOSIcon.png" style="position:absolute;top:2px;left:3px;" />
    <p style="position:absolute;top:5px;left:35px;">CRowViewCL</p>
 </div>
    <!-- TITLE END-->
    
    <!--WORK AREA START-->
    <div style="position:relative;border-style:solid;border-width:10px;border-top-width:2px;border-color:#66FFFF;background:black;height:100%;">
    <!-- CONTEXT MENU START-->
<div style="
box-shadow: inset 0px -11px 8px -10px #484848; 
color:black;
background-color:#314151;
position:relative;
height:20px;
width:100%;
font-size:15px;"><p style="position:absolute;top:0px;;left:5px;">File      Project      Window</p>
</div>
        <!-- CONTEXT MENU END-->
        <!-- Source bar START -->
<div style=" 
...
width:100%;
font-size:12px;
font-family:monospace;"><p style="position:absolute;top:0px;left:10px;">Sources</p>
</div>
        <!-- Source bar END -->
<marquee style="text-align:left;position:relative; overflow:hidden;color:cyan; font-size:12px; height:100%; width:100%;" direction="up" scrollamount="20">
  <code>
    <pre>
...
<p id="afx_close">X</p></a>
    <!-- TITLE START-->
<div class="handle" style="background-color: #35DFAD;">
<img alt="AppIcon" src="/img/ShrunkenCoplandOSIconBlack.png" style="position:absolute;top:2px;left:3px;" />
<p style="position:absolute;top:5px;left:35px;">Afx-n-nPrv-ViewCL</p>
</div>
    <!-- TITLE END-->
    <!--WORK AREA START-->
    <div style="position:relative;border-style:solid;border-width:10px;border-color:#a4c4c6;border-top-width:2px;background:black;">
    <!-- CONTEXT MENU START-->
<div style="
box-shadow: inset 0px -11px 8px -10px #484848; 
color:black;
background-color:#79e2a9;
position:relative;
height:20px;
width:100%;
font-size:15px;"><p style="position:absolute;top:0px;;left:5px;">File      Project      Window</p>
...
<div style=" 
color:white;
background-color:#032d11;
position:relative;
height:15px;
width:100%;
font-size:12px;
font-family:monospace;">
<p style="position:absolute;top:0px;left:10px;">Sources</p>
</div>
        <!-- Source bar END -->
<marquee style="text-align:left;position:relative; overflow:hidden;color:#00ff00; font-size:10px;height:600px;" direction="up" scrollamount="20">
<code>
    <pre>
...
<!-- Afx-n-nPrv-View.CL END -->


<!-- Start of Navi handles -->
<div style="position:fixed;right:30px;top:5%;">
  <div> <!-- Start of handle 1 -->
  <p id="vidopen" class="task">Media</p>
  <img alt="handle" class="tbhandle" src="/img/navihandle.png"/>
  </div> <!--End of handle 1 -->
  
  <div> <!-- Start of handle 2 --><a>
  <p id="building" class="task">Building</p></a>
  <img alt="handle" class="tbhandle" src="/img/navihandle.png"/>
  </div> <!--End of handle 2 -->
  
  <div> <!-- Start of handle 3 --><a>
  <p id="work" class="task">IDE</p></a>
  <img alt="handle" class="tbhandle" src="/img/navihandle.png"/>
  </div> <!--End of handle 3 -->
</div><!-- END of Navi handles -->

<!-- Start of video player -->
<div id="cmp">
<p id="vidclose" style="display:hidden;position:absolute;color:black;text-align:right;font-family:Arial;font-size:24px;right:5px;">X</p>
<!-- TITLE START-->
<div class="handle" style="width:90%;">
<img alt="AppIcon" draggable="false" src="/img/ShrunkenCoplandOSIcon.png" style="position:absolute;top:2px;left:3px;" />
<p style="position:absolute;top:5px;left:35px;">CoplandOS Media Player</p>
</div>
<!-- TITLE END-->
<iframe id="cmp1" allowfullscreen src="//www.youtube.com/embed/p9kYAEyVjEY?autoplay=0&amp;playlist=PL29CFFB0C178E4903&amp;enablejsapi=1&amp;start=18?html5=1" frameborder="0" 
style="height:100%;width:100%;"></iframe>
</div><!-- End of video player -->

<!--  Beginning of Return shaft. -->
<div class="shaft" style="left:-95px;margin-left:5%;height:400px;">
<img alt="lightshaft" draggable="false" src="/img/light.png" style="position:absolute;left:45px;"/>
<a href="/">
<p class="light">Return</p></a>
</div><!--  End of return shaft -->

<!--  Beginning of WORK shaft. -->
<div class="shaft" style="display:hidden;margin-left:15%;height:300px;">
<img alt="lightshaft" draggable="false" src="/img/light.png" style="position:absolute;left:-50px;"/>
<a href="/Layer/matrix">
 <p class="light" style="left: -105px;">Connect</p></a>  
</div><!--  End of WORK shaft -->

<marquee class="clines" scrollamount="20" direction="left" style="bottom:0px;left:0px;">CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS   CoplandOS</marquee>
...
export default function InfornographyPage() {
  return (
    <>
      <link rel="stylesheet" href="/stylesheets/infornography.css" />
      <link rel="shortcut icon" href="/favico/faviconi.ico" />
      <title>wired.infornography.neocities</title>
      <LayerNav />
      <div dangerouslySetInnerHTML={{ __html: HTML }} />
      <Script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js" strategy="afterInteractive" />
      <Script src="https://code.jquery.com/ui/1.10.4/jquery-ui.js" strategy="afterInteractive" />
      <Script src="/js/libs/randtext.js" strategy="afterInteractive" />
      <Script src="/js/infornography.js" strategy="afterInteractive" />
    </>
  );
}
